...
FOREACH(COMPONENT ${OpenCV_COMPONENTS})
    ...
    MARK_AS_ADVANCED(OpenCV_${UPPERCOMPONENT}_INCLUDE_DIR 
        OpenCV_${UPPERCOMPONENT}_LIBRARY OpenCV_${UPPERCOMPONENT}_FOUND)
...
FOREACH(COMPONENT ${OpenCV_FIND_COMPONENTS})
    ...
    IF(OpenCV_${UPPERCOMPONENT}_LIBRARY AND OpenCV_${UPPERCOMPONENT}_INCLUDE_DIR)
        ...
        MESSAGE(STATUS "found lib${LOWERCOMPONENT}: 
            -I${OpenCV_${UPPERCOMPONENT}_INCLUDE_DIR}, 
            ${OpenCV_${UPPERCOMPONENT}_LIBRARY}"
            )
